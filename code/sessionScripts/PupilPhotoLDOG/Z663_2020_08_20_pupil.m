...
pupilCircleThreshSet = [0.062, 0.062, 0.062, 0.062, 0.062, 0.05, 0.062, 0.062, 0.062, 0.062, 0.95, 0.096];

pupilRangeSets = {[50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 130], [50 130]};
candidateThetas = {[pi/2; pi],[pi],[pi],[pi; 4*pi/6],[pi; 4*pi/6],[pi/2],[3*pi/2],[3*pi/2],[5*pi/4],[5*pi/4],[0; 5*pi/4],[3*pi/2]};

ellipseEccenLBUB = {[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.9],[0.2 0.6]};

glintPatchRadius = [20,20,20,35,35,35,35,20,20,20,20,20];
