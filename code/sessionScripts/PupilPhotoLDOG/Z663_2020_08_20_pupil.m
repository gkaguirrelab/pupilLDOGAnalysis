...
candidateThetas = {[pi/2; pi],[pi],[pi],[pi; 4*pi/6],[pi; 4*pi/6],[pi/2],[3*pi/2],[3*pi/2],[5*pi/4],[pi; pi/2; pi/3],[pi/2; pi],[pi/2; pi]};
...
glintPatchRadius = [20,30,20,35,35,35,35,20,20,60,60,60];
