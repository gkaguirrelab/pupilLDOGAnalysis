...
pupilCircleThreshSet = [0.062, 0.062, 0.062, 0.062, 0.062, 0.05, 0.062, 0.062, 0.062, 0.062, 0.2, 0.1];

pupilRangeSets = {[50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [50 78], [90 140], [90 140]};
candidateThetas = {[pi/2; pi],[pi],[pi],[pi; 4*pi/6],[pi; 4*pi/6],[pi/2],[3*pi/2],[3*pi/2],[5*pi/4],[5*pi/4],[pi/2; pi],[pi/2; pi]};
...
glintPatchRadius = [20,20,20,35,35,35,35,20,20,20,50,60];
...
ellipseAreaUP = [90000, 50000, 50000, 50000, 50000, 50000, 50000, 50000, 50000, 50000, 90000, 90000];
