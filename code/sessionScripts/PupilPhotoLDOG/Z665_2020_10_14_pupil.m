...
% Stimulus properties
sets = {[1 7],[8 8],[3 9],[4 10],[5 11], [6, 12]};
...
pupilCircleThreshSet = [0.08, 0.065, 0.065, 0.08, 0.137, 0.1, 0.1, 0.1, 0.125, 0.187, 0.199, 0.198];

pupilRangeSets = {[90 119], [90 119], [90 119], [90 119], [90 119], [90 113], [90 119], [90 113], [90 113], [116 144], [116 144], [116 144]};
candidateThetas = {[3*pi/4],[pi; 0],[5*pi/4],[pi],[pi],[5*pi/4],[pi],[3*pi/4; pi],[5*pi/4],[5*pi/4],[pi],[pi]};
