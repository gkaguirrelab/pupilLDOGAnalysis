...
% Stimulus properties
sets = {[1 4 7 10],[2 5 8 11],[3 6 9 12]};
...
pupilCircleThreshSet = [0.06, 0.06, 0.06, 0.15, 0.068, 0.1, 0.1, 0.1, 0.1, 0.068, 0.068, 0.1];

pupilRangeSets = {[60 80], [60 80], [60 80], [90 130], [60 80], [80 120], [80 120], [80 120], [80 120], [65 90], [65 90], [80 120]};
candidateThetas = {[pi],[pi],[pi],[3*pi/4],[pi],[pi/2],[pi/4],[pi],[pi],[pi],[pi],[pi]};
...
glintPatchRadius = [40,40,40,50,60,55,40,40,40,40,40,40];

minRadiusProportion = [0, 0, 0, 0.35, 0, 0, 0, 0, 0, 0, 0, 0];

cutErrorThreshold = [2,2,2,1,2,2,2,2,2,2,2,2];
...
pupilGammaCorrection = [0.75,0.75,0.75,0.75,0.55,0.55,0.55,0.55,0.55,0.75,0.75,0.65];
