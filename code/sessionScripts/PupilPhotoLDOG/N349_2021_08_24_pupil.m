...
candidateThetas = {[pi],[pi],[pi],[pi/2],[pi/2; 3*pi/2],[pi/2],[pi/2],[pi/2],[pi/2],[pi/2],[pi/2],[pi/2]};
...
glintPatchRadius = [45,45,45,55,55,55,55,55,65,55,55,45];
...
glintGammaCorrection = [0.75,0.75,0.75,0.75,0.85,0.75,0.75,0.75,0.75,0.75,0.75,0.75];
pupilGammaCorrection = [0.65,0.65,0.65,0.50,0.40,0.50,0.50,0.30,0.45,0.30,0.30,0.30];
