...
candidateThetas = {[5*pi/4],[5*pi/4],[5*pi/4],[pi; 3*pi/2],[3*pi/2],[3*pi/2; pi],[5*pi/4],[5*pi/4],[pi],[pi; 5*pi/4],[pi; 5*pi/4],[pi; 5*pi/4]};

ellipseEccenLBUB = {[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.3 0.5],[0.35 0.45],[0.4 0.5]};

glintPatchRadius = [25,20,20,20,20,20,20,20,20,20,20,20];
...
for ii = 1:numVids
    ...
    sessionKeyValues = {...
        ...
        'radiusDivisions',50,...
        'ellipseTransparentLB',[0,0,5000, ellipseEccenLBUB{ii}(1), 0],...
        'ellipseTransparentUB',[1280,720,15000,ellipseEccenLBUB{ii}(2), pi],...
        };
