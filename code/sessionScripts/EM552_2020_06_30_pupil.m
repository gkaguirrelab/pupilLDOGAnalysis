...
candidateThetas = {[7*pi/4],[5*pi/4],[5*pi/4],[3*pi/2; pi],[3*pi/2],[3*pi/2; pi],[5*pi/4],[5*pi/4],[pi],[3*pi/2; 5*pi/4],[pi; 5*pi/4],[pi; 5*pi/4]};
...
ellipseAreaUP = [15000, 15000, 15000, 15000, 15000, 15000, 15000, 15000, 15000, 25000, 15000, 15000];
