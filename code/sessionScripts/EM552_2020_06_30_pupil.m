...
% videoNameStems = {...
%     'pupil_RodMel_1-6Hz_RightEyeStim_02'};
% pupilCircleThreshSet = [0.0160];
% pupilRangeSets = {[41 50]};
% glintFrameMaskSet = {[224   290   234   329]};
% pupilFrameMaskSet = {[191   259   176   284]};
...
for ii = 1:numVids
    ...
    sessionKeyValues = {...
        ...
        'glintPatchRadius',50,...
        'candidateThetas',[pi],...
        'ellipseTransparentLB',[0,0,400,0.53, 0],...
        'ellipseTransparentUB',[1280,720,90000,0.63, pi],...
