...
% videoNameStems = {...
%     'pupil_LplusS_1-6Hz_LeftEyeStim_06'}; % cut [3*pi/2 5*pi/4]
% pupilCircleThreshSet = [0.0530];
% pupilRangeSets = {[55 67]};
% glintFrameMaskSet = {[129   318   326   298]};
% pupilFrameMaskSet = {[44   184   222   208]}; 
...
for ii = 1:numVids
    ...
    sessionKeyValues = {...
        ...
        'glintPatchRadius',20,...
        'candidateThetas',[pi 3*pi/2 5*pi/4],...
        'ellipseTransparentLB',[0,0,400,0.3, 0],...
        'ellipseTransparentUB',[1280,720,90000,0.7, pi],...
