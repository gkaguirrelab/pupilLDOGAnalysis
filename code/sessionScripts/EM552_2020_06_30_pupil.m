...
candidateThetas = {[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4],[5*pi/4; pi],[5*pi/4; pi]};

ellipseEccentLBUB = {[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.3 0.45],[0.2 0.7],[0.3 0.7]};
...
for ii = 11:numVids
    ...
    sessionKeyValues = {...
        ...
        'ellipseTransparentUB',[1280,720,30000,ellipseEccentLBUB{ii}(2), pi],...
        };
