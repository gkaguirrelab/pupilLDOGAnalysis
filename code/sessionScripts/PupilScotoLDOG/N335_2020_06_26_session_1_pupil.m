...
candidateThetas = {[3*pi/2], [pi/2; pi], [pi/2; pi], [pi/2; pi], [pi/2; pi], [pi/2; pi], [pi/2; pi], [pi/2; pi]};

ellipseEccenLBUB = {[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6],[0.2 0.6], [0.2 0.6], [0.2 0.6]};

glintPatchRadius = [25,25,25,25,25,25, 25, 25];
...
for ii = vids
    ...
    sessionKeyValues = {...
        'minRadiusProportion', -0.2, ...
        'pupilGammaCorrection', 1.25, ...
        'startFrame',1, ...
        'nFrames', 100, ...
        'checkCountTRs',checkCountTRs, ...
        'glintFrameMask',glintFrameMask,...
        'glintGammaCorrection',0.9,...
        'glintThreshold',0.5,...
